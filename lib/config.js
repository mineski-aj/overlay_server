...
const TESTGAMES_DIR  = path.join(POSTGAME_DIR, "Testgames");
...
if (!fs.existsSync(TESTGAMES_DIR)) fs.mkdirSync(TESTGAMES_DIR);
...
module.exports = {
  PORT, POLL_MS,
  POSTGAME_DIR, TESTGAMES_DIR, POSITIONS_FILE, EVENTS_FILE, FIGHTS_FILE, CONFIG_PATH,
  GAME_API, MAIN_API,
